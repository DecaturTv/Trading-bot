...
_INSERT_SQL = "INSERT INTO ml_trade_outcomes (symbol, closed_at, pnl, asset_class) VALUES ($1, $2, $3, $4)"
...
class TradeOutcomeRepository:
    ...
    async def record_outcome(self, symbol: str, closed_at: datetime, pnl: float, asset_class: str = "equities") -> None:
        async with self._pool.acquire() as conn:
            await conn.execute(_INSERT_SQL, symbol, closed_at, pnl, asset_class)
